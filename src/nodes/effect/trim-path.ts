...
// Rasterize Spline. Both sliders keyframe, so animating `end` 0→1 draws on.
...
export const trimPathNode: NodeDefinition = {
  ...
  description:
    "Reveal only a portion of a path by arc length. Start/end (0–1, across all subpaths) animate a draw-on. Outputs a spline — view it with Stroke or Rasterize Spline.",
  backend: "webgl2",
